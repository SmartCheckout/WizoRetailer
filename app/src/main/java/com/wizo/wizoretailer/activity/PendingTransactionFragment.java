...
public class PendingTransactionFragment extends WizoFragment {
    private AsyncHttpClient ahttpClient = new AsyncHttpClient();
    private View mView;
    private ProgressBar mProgressBar;
    private ListView mPendingTransactionListView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,  @Nullable Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.transaction_history_pending, container, false);
        Bundle inputBundle = getArguments();
        // Step 2 : Get the list view and progress bar
        mProgressBar = mView.findViewById(R.id.progress_bar);
        mPendingTransactionListView = mView.findViewById(R.id.pending_transaction_list);
        ...
        if (inputBundle != null && inputBundle.getBoolean("cache")) {
            ...
            if (StateData.pendingTransactionList != null) {
                TransactionListViewAdapter transactionListViewAdapter = new TransactionListViewAdapter(getActivity(), StateData.pendingTransactionList, R.layout.pending_transaction_item);
                mPendingTransactionListView.setAdapter(transactionListViewAdapter);
            }
            return mView;
        }
    ...
    protected void getPendingTransactions(){
        ...
        rqstparams.put("status", TransactionStatus.PAYMENT_SUCCESSFUL);
